...
<div align="right" style='padding: 0px;margin-left:8px;margin-bottom:55px;'>
<?php
if($div_seleccionado==0)
{
?>
<button style="float:left;margin-left:3px;margin-top:0px;" name="boton" type="button" onclick="window.location.href='<?php echo "$ruta_absoluta/editar_actas/$anyo/$tipo_acta";?>'"  title="<?php echo $boton_volver;?>"/>
<img src="<?php echo "$ruta_absoluta/images/volver.png";?>" style='width:35px'>
</button>
<?php
}
else {
?>
<button style="float:left;margin-left:3px;margin-top:0px;" name="boton" type="button" onclick="window.location.href='<?php echo "$ruta_absoluta/redactar_actas/$tipo_acta/$id_acta/$div_seleccionado";?>'"  title="<?php echo $boton_volver;?>"/>
<img src="<?php echo "$ruta_absoluta/images/volver.png";?>" style='width:35px'>
</button>
<?php
}
?>
<button  style="float:left;margin-left:3px;margin-bottom:0px;" name="boton" type="button" class="print" rel="acuerdos"  onclick="return confirmar('<?php echo "$actatexto86";?>')"  title="<?php echo $actatexto70;?>"/>
<img src="<?php echo "$ruta_absoluta/images/imprimir_acuerdos.png";?>" style='width:35px'>
</button>
<button style="float:left;margin-left:3px;margin-top:0px;" name="boton" type="button" class="print" rel="acta" onclick="return confirmar('<?php echo "$actatexto86";?>')"  title="<?php echo $actatexto69;?>"/>
<img src="<?php echo "$ruta_absoluta/images/imprimir_acta.png";?>" style='width:35px'>
</button>
...
<div id="titulo_2" style="padding-top:10px;" align='right'>
...
<?php
				...
				$nombre_ciutat=mysql_query("SELECT POBLACION FROM 1_centro where cod_centro='$upload_centro'");
