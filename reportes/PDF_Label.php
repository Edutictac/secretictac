...
class PDF_Label extends FPDF {
    ...
    var $_Avery_Labels = array(
        ...
        //'L7163'=> array('paper-size'=>'A4',        'metric'=>'mm',    'marginLeft'=>5,        'marginTop'=>37,         'NX'=>2,    'NY'=>7,    'SpaceX'=>25,        'SpaceY'=>0,    'width'=>99.1,        'height'=>38.1,        'font-size'=>9)
         'L7163'=> array('paper-size'=>'A4',        'metric'=>'mm',    'marginLeft'=>6.9,        'marginTop'=>58.5,         'NX'=>6,    'NY'=>6,    'SpaceX'=>2.1,        'SpaceY'=>23,    'width'=>25.3,        'height'=>20.1,        'font-size'=>7)
    );
    ...
    function Add_Label($text) {
        ...
        if ($this->_COUNTX == $this->_X_Number) {
            ...
            if ($this->_COUNTY == $this->_Y_Number) {
                ...
                $this->_COUNTY=0;
                //$this->AddPage(); LA HE QUITADO YO, LO HAGO DESDE LA PAGINA
            }
        }
