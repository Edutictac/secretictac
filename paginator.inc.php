 ...
 */
 ...
 $trozo_ruta = explode("/", $_pagi_enlace); //siempre han de ser tres

 function contar_palabras($cadena){
    return sizeof(explode("/", $cadena));
}
$num_trozos= contar_palabras($_pagi_enlace);

 if($num_trozos>3)
 {
 $_pagi_enlace=$trozo_ruta[0]."/".$trozo_ruta[1]."/".$trozo_ruta[2]."/";
 $_pagi_enlace= explode("?", $_pagi_enlace);
 $_pagi_enlace=$_pagi_enlace[0];
 $_pagi_query_string = "";
 }
 else
 {
 ...
 foreach($_pagi_propagar as $var){
	...
	//ESTO era lo que habia antes y lo he cambiado yo	$_pagi_query_string.= $GLOBALS[$var]."&";
